...
const ImageIcon = () => {
  return(
    <svg width="17" height="13" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M15.5 9.75C15.5 12.2353 13.4853 14.25 11 14.25C8.51472 14.25 6.5 12.2353 6.5 9.75C6.5 7.26472 8.51472 5.25 11 5.25C13.4853 5.25 15.5 7.26472 15.5 9.75Z" stroke="#0F172A" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round"/>
      <path d="M17.75 7.5H17.7575V7.5075H17.75V7.5Z" stroke="#0F172A" strokeWidth="1.8" strokeLinecap="round" stroke-linejoin="round"/>
    </svg>
  )
}
