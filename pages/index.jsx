        ...
        <div className="antialiased">
          <div className="min-h-screen flex">
            ...
            <main className="grow overflow-hidden">
              ...
              {/*  Page sections */}
              <Hero title="Welcome to D-Luma-Labs!" description="Respectful and good-faith discussion should be the cornerstone of any decision-making process. In trying to enact change, please keep this principle in mind." image={<BigLogo />} />
